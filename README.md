...
[![](https://img.shields.io/badge/Cocos%20Creator-3.8.8-green.svg)](http://www.cocos.com/creator)
...
[gg-hot-update/热更新插件](https://store.cocos.com/app/detail/6756) 的官方示例项目，当前示例项目对应的插件版本为 **`v6`** 版本。
